...
int main(int argc, char** argv)
{
  ...
  vkSetup.enableAftermath = true;  // We want Aftermath
  ...
  spec.queues.push_back({vkContext.m_queueGCT.familyIndex, vkContext.m_queueGCT.queueIndex, vkContext.m_queueGCT.queue});
